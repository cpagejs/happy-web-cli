import Cpage, { Component, Dom } from 'cpage';
...
export default class Main extends Component {
  constructor() {
    ...
    this.template = `
      <div>
        ...
        <div c-show="{{a>10}}">a>10 show</div>
        <footercomp text="footer component props"/>
      </div>
    `;
    this.data = {
      text: 'text',
  ...
  handelClick() {
    this.$data('json', { 'title': 'demo' });
    this.$data('isShow', !this.data.isShow);
    this.$data('a', Math.random()*20);
  }
